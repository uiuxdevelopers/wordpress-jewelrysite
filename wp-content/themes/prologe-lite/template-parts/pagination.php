...
$prev_text = sprintf(
	...
	'<span aria-hidden="true" title="' . __( 'Newer Posts', 'prologe-lite' ) . '">&larr;</span>',
	__( 'Newer <span class="nav-short">Posts</span>', 'prologe-lite' )
);
$next_text = sprintf(
	'<span class="nav-next-text screen-reader-text">%s</span> %s',
	__( 'Older <span class="nav-short">Posts</span>', 'prologe-lite' ),
	'<span aria-hidden="true" title="' . __( 'Older Posts', 'prologe-lite' ) . '">&rarr;</span>'
);
